...
namespace nuslam
{
    ...
    public:
        ...
        void add_new_measurment(const Measurement &meas);
        ...
        /// \brief predicts the next step - finds the estimated state and coveriance.
        /// \param twist - the twist of the robot.
        ...
        /// \brief add a new zero row and column to a matrix (used when adding new landmark).
