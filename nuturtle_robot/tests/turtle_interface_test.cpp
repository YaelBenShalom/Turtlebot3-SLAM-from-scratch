...
TEST_CASE("Test for turtle_interface ROS API cmd_vel to wheel_cmd") {
  ...
  ros::Subscriber wheel_cmd_sub =
      nh.subscribe("/wheel_cmd", 1, wheel_cmd_callback);
...
//     ros::NodeHandle nh;
//     ros::Subscriber joint_state_sub = nh.subscribe("/joint_state", 1,
//     joint_state_callback); ros::Publisher sensor_pub =
//     nh.advertise<nuturtlebot::SensorData>("/sensor_data", 1, true);
...
//         REQUIRE( rigid2d::almost_equal(wheel_angle.right_wheel_angle, 0.1534,
//         1e-3)); REQUIRE( rigid2d::almost_equal(wheel_angle.left_wheel_angle,
//         0.1534, 1e-3)); REQUIRE(
//         rigid2d::almost_equal(wheel_vel.right_wheel_vel, 0.1534, 1e-3));
//         REQUIRE( rigid2d::almost_equal(wheel_vel.left_wheel_vel, 0.1534,
//         1e-3));
//     }
// }