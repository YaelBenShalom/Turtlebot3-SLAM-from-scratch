...
class TurtleInterface
{
    public:
        ...
        void load_parameter() {
            ...
            nh.getParam("max_trans_speed", max_trans_speed);        // The maximum translational speed of the motor
            nh.getParam("max_rot_speed", max_rot_speed);            // The maximum rotational speed of the motor
            nh.getParam("max_motor_rot", max_motor_rot);            // The maximum rotational speed of the motor
        ...
        void sensor_data_callback(const nuturtlebot::SensorData &data) {
            right_angle = rigid2d::normalize_angle((2*data.right_encoder * rigid2d::PI) / resolution);
            left_angle = rigid2d::normalize_angle((2*data.left_encoder * rigid2d::PI) / resolution);
    ...
    private:
        ...
        double wheel_base, wheel_radius, max_trans_speed, max_rot_speed, max_motor_rot, resolution;
