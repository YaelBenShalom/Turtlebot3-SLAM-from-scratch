...
/// SERVICES:
///     Control (control): Causes the robot to travel either clockwise, counter clockwise, or stop.
    ...
    public:
        ...
        void main_loop() {
            ...
            while(ros::ok()) {
                ...
                ROS_INFO("turtle_speed = %f\t turtle_controlled_speed = %f\r", turtle_speed, turtle_controlled_speed);
