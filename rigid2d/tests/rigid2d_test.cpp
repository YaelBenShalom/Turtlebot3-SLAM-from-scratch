...
TEST_CASE("Test function deg2rad(deg)") {
  ...
  // REQUIRE( rigid2d::almost_equal(rigid2d::deg2rad(360.0), rigid2d::PI));  //
...
TEST_CASE("Test function rad2deg(rad)") {
  ...
  // REQUIRE( rigid2d::almost_equal(rigid2d::rad2deg(rigid2d::PI), 360.0));  //
  // This test should fail
}
...
TEST_CASE("Test functions deg2rad(deg) and rad2deg(rad)") {
  ...
  // REQUIRE( rigid2d::almost_equal(rigid2d::rad2deg(180.0), 360.0));  // This
  // test should fail
}
